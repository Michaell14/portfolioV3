        ...
        <>
            ...
            <Container maxW={"3xl"}>
                ...
                <Flex gap={5} mt={"60px"}>
                    ...
                    <Box className={styles.line} position={"relative"}>
                        <Box ml={5}>
                            <Text className={styles.title}>Penn <span style={{textDecoration: "underline 2px"}} className={"hideText"}><a href="https://pennspark.org/" rel={"noreferrer"} target={"_blank"}>SPARK</a></span> - Back-End Developer</Text>
                            <Text className={styles.description} fontSize={"15px"} mt={1.5}> 
